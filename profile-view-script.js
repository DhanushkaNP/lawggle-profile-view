window.onload = async function () {
  ...
  if (lawyerId != null && lawyerId != "") {
    ...
    if (thisUser != "error") {
      ...
      let imagecontainer = document.getElementById("theprofileimagecontainer");
      imagecontainer.style.backgroundImage = `url(${imageurl})`;
      imagecontainer.style.backgroundSize = "cover";
      imagecontainer.style.backgroundPosition = "center";
      imagecontainer.style.backgroundRepeat = "no-repeat";
      document.getElementById("NameText").innerText = parsedBody["name"];
      document.getElementById("thefirmurl").innerText = parsedBody["firm url"];
      ...
      if (certificates.length > 0) {
        ...
        if (
          ...
          for (let eachcert in certificates) {
            ...
            certimage.src = certificates[eachcert];
      ...
      if (
        ...
        document.getElementById("sectionprofilevide0").style.display = "none";
      }
      ...
      if (clientTestimonials.length > 0) {
        ...
        for (i = 0; i <= max - 1; i++) {
          ...
          testimonialVideo.classList.add("videoclass", "testimonialcontainer");
      ...
      let blogs = blogsJson;
      let themainblogcontainer = document.getElementById("mainblogscontainer");
      ...
      if (blogsJson.length > 0) {
        for (let blog in blogsJson) {
          ...
          const previewArticle = document.createElement("previewbox-article");
      ...
      if (theQAs.length > 0) {
        for (let eachQa in theQAs) {
          ...
          theqaheader.addEventListener("click", function () {
            ...
            let thecontainers = document.querySelectorAll(".accordion-item-c");
